...
{
    session_destroy();
    header('Location: ./twitter_auth2.php');
}
...
{   //Success, redirected back from process.php with varified status.
    ...
    if(isset($_POST["updateme"]))
    {
        ...
        die('<script type="text/javascript">window.top.location="twitter_auth2.php"</script>'); //redirect back to index.php
    }

    //show tweet form
    echo '<div class="tweet_box">';
    echo '<form method="post" action="twitter_auth2.php"><table width="200" border="0" cellpadding="3">';
    echo '<tr>';
    ...
    //login button
    echo '<a href="twitter_auth3.php"><img src="img/sign-in-with-twitter-l.png" width="151" height="24" border="0" /></a>';
}
